...
knit_error( {
  plots$ntprobnp_ecdf <- ecdf(plots$ntprobnp$data$values)
...
knit_error( {
  plots$ntprobnp_ecdf_c <- ecdf(cohort_report$NTproBNP.valueQuantity.value)
  embed_var(plots$ntprobnp_ecdf_c, name = "NTproBNP_ECDF_c.rds", text = "[Get NTproBNP Distribution Plot 2 (c) as .ecdf]")
}, 'Could not crate plot exports. Error: ')
knit_error( {
...
knit_error( {
  plots$age_ecdf <- ecdf(plots$age$data$values)
...
knit_error( {
  plots$age_ecdf_c <- ecdf(cohort_report$age)
  embed_var(plots$age_ecdf_c, name = "NTproBNP_ECDF_c.rds", text = "[Get Age Distribution Plot 2 (c) as .ecdf]")
}, 'Could not crate plot exports. Error: ')
knit_error( {
