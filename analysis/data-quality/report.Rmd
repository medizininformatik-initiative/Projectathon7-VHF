...
value_labels <- as.data.table(t(metadata_report$VALUE_LABELS[3:8]))
colnames(value_labels) <- metadata_report$VAR_NAMES[3:8]
...
knit_error(smith_dq_report$long_format$con_limit_deviations$results[[1]]$SummaryPlotList$ntprobnp, 'Could not print Limit SummaryPlot for Cohort. Error: ')
...
knit_error(smith_dq_report$long_format$con_limit_deviations$results[[1]]$SummaryTable, 'Could not print Limit SummaryTable for Cohort. Error: ')
...
knit_error(smith_dq_report$long_format$con_limit_deviations$results[[1]]$SummaryPlotList$gender, 'Could not print SummaryPlotList$gender for Cohort. Error: ')
...
knit_error(smith_dq_report$long_format$con_limit_deviations$results[[1]]$SummaryPlotList$age, 'Could not print SummaryPlotList$age for Cohort. Eorror: ')
...
knit_error(smith_dq_report$long_format$con_limit_deviations$results[[1]]$SummaryPlotList$NTproBNP.code, 'Could not print SummaryPlotList$NTproBNP.code for Cohrot. Error: ')
...
knit_error(smith_dq_report$long_format$con_limit_deviations$results[[1]]$SummaryPlotList$comparator, 'Could not print SummaryPlotList$comparator for Cohort. Error: ')
...
knit_error(smith_dq_report$long_format$con_limit_deviations$results[[1]]$SummaryPlotList$NTproBNP.unit, 'Could not print SummaryPlotList$NTproBNP.unit for Cohort. Error: ')
...
#Plot
knit_error(smith_dq_report$long_format$com_item_missingness$results[[1]]$SummaryPlot, 'Could not print Missingness SummaryPlot for Cohort. Error: ')
