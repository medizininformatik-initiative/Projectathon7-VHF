...
```{r include=FALSE}
### LIBRARIES ------------------------
# this script requiers dataquieR version 1.0.9
#packageVersion("dataquieR")
# if a different verison is installed use
#utils::install.packages(pkgs = "https://cran.r-project.org/src/contrib/Archive/dataquieR/dataquieR_1.0.9.tar.gz", repos = NULL)
...
#### This report was created with the [dataquieR](https://dataquality.ship-med.uni-greifswald.de/tutorials2.html) (Version 1.0.9) Package for R.
...
knit_error(acc_plots <- acc_distributions(resp_vars      = NULL, 
                         ...
                         study_data     = cohort_report, 
                         meta_data      = metadata_report), 
           'Could not generate SummaryPlotList for Cohort. Error: ')
...
knit_error(table(smith_dq_report$study_data$gender), 'Could not tab SummaryPlotList$gender for Cohrot. Error: ')
